...
function AboutHeroActions({ isDark, t }: { isDark: boolean; t: ReturnType<typeof useTranslations> }) {
    return (
        <motion.div 
        ...
        <div ref={sectionRef} className="min-h-screen w-full flex justify-center items-center pt-28 overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    {/* CTA buttons */}
                    <AboutHeroActions isDark={isDark} t={t} />
                </motion.div>
            </motion.div>
        </div>
    );
...
function LiteAboutHeroSection() {
    ...
    return (
        <div className="min-h-screen w-full flex justify-center items-center pt-28 overflow-hidden">
            <motion.div
                className="app-container grid grid-cols-6 gap-8 place-items-center"
            ...
            >
                ...
                >
                    <div className="relative aspect-[5/5] md:aspect-[4/5] overflow-hidden rounded-b-4xl md:rounded-b-xl rounded-t-4xl md:rounded-t-full border border-white/10 bg-background-secondary">
                        <Image
                            src="/assets/images/me-coding.jpg"
                            alt="Abdoul"
                            fill
                ...
                >
                    ...
                    >
                        ...
                        <RevealText direction="up" delay={0.28} duration={0.55}>
                            <p>{t("about.bio2")}</p>
                        </RevealText>
                        <RevealText direction="up" delay={0.36} duration={0.55}>
                            <p>{t("about.bio3")}</p>
                        </RevealText>
                    </motion.div>
...
export function AboutHeroSection() {
    ...
    return useLiteAnimations ? <LiteAboutHeroSection /> : <RichAboutHeroSection />;
}
