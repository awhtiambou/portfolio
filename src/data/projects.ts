...
export const projects: Project[] = [
  ...
  // ─── 3. TIAMSHOP ────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        elements: [
          ...
          },
          {
            type: "stat-grid",
            stats: [
              { label: "$t:tiamshop-ecommerce-platform.sections.overview.stat0.label", value: "70+", note: "$t:tiamshop-ecommerce-platform.sections.overview.stat0.note" },
              ...
              { label: "$t:tiamshop-ecommerce-platform.sections.overview.stat2.label", value: "6", note: "$t:tiamshop-ecommerce-platform.sections.overview.stat2.note" },
              { label: "$t:tiamshop-ecommerce-platform.sections.overview.stat3.label", value: "3", note: "$t:tiamshop-ecommerce-platform.sections.overview.stat3.note" },
            ],
          },
        ],
      },
            ...
            images: [
              {
                ...
                alt: "$t:tiamshop-ecommerce-platform.sections.features.img0.alt",
                caption: "$t:tiamshop-ecommerce-platform.sections.features.img0.caption",
              },
              {
                src: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=2670&auto=format&fit=crop",
                alt: "$t:tiamshop-ecommerce-platform.sections.features.img1.alt",
                caption: "$t:tiamshop-ecommerce-platform.sections.features.img1.caption",
              },
            ],
          },
        ],
        ...
        elements: [
          {
            type: "callout",
            variant: "info",
            title: "$t:tiamshop-ecommerce-platform.sections.architecture.callout.title",
            content: "$t:tiamshop-ecommerce-platform.sections.architecture.callout.content",
          },
          {
            type: "image",
            src: "https://images.unsplash.com/photo-1472851294608-062f824d29cc?q=80&w=2670&auto=format&fit=crop",
    ...
    technologies: [
      ...
      "Dapper", "Entity Framework", "Mailgun",
    ],
